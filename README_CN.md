...
- 覆盖 17 种图表类型，细分样式（堆叠、横向、极坐标、双 Y 轴、玫瑰图……）不需要换工具
...
17 种，分四组。每种的 data 结构、示例数据与实测渲染图见 [`docs/chart-types.md`](https://github.com/Ivan97/echarts-mcp/blob/main/docs/chart-types.md)。
